...
class AddonSeeder extends Seeder
{
    ...
    public function run()
    {
        Addon::create([
            ...
            'image_path' => asset('storage/images/addons/function hall.jpg'),
        ]);
        ...
        Addon::create([
            ...
            'image_path' => asset('storage/images/addons/bbq grill.jpg'),
        ]);
        ...
        Addon::create([
            ...
            'image_path' => asset('storage/images/addons/karaoke.jpg'),
        ]);
        ...
        Addon::create([
            ...
            'image_path' => asset('storage/images/addons/additional person.png'),
        ]);
        ...
        Addon::create([
            ...
            'image_path' => asset('storage/images/addons/balloons and party.jpg'),
        ]);
    }
}
